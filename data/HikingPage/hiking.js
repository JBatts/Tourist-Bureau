...
let hikes = [
    {
       ...
       scenicImage: "../data/HikingPage/birding_loop_1.png",
       trailMapImage: "../data/HikingPage/birding_loop_2.png",
       length: "2.3 miles", 
       difficulty: 2 
    },
    {
        ...
        scenicImage: "../data/HikingPage/deep_blue_1.png",
        trailMapImage: "../data/HikingPage/deep_blue_2.png",
        length: "2 miles", 
        difficulty: 2 
     },
     {
        ...
        scenicImage: "../data/HikingPage/overlook_trail_1.png",
        trailMapImage: "../data/HikingPage/overlook_trail_2.png",
        length: ".7 miles", 
        difficulty: 2 
     },
 ];